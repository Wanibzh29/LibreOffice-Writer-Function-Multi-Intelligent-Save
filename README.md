# LibreOffice-Writer-Function-Multi-Intelligent-Save
A function to save files in differents places and also to save the path so next time the file will be saved it will save in each place.
